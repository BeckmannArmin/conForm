...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    generatePDF: function generatePDF() {
      var doc = new jspdf__WEBPACK_IMPORTED_MODULE_3__["default"]();
      var html = this.$el.innerHTML;
      console.log(html);
      doc.setFontSize(12).text(this.conceptPaper.course, 0.5, 3.5, {
        align: 'left',
        maxWidth: '7.5'
      });
      /** Footer of doc */

      doc.text("This is a simple footer located .5 inches from page bottom", 0.5, doc.internal.pageSize.height - 0.5);
      doc.save("".concat(this.conceptPaper.name, ".pdf"));
    }
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("h2", [_vm._v("The course is: " + _vm._s(_vm.conceptPaper.course))]),
      _vm._v(" "),
      _c(
        "button",
